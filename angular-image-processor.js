...
(function() {
  angular.module('angular-image-processor').service('imageProcessor', function($q, logger) {
    return {
      startTime: 0,
      lastTime: 0,
      logTime: function(methName) {
        this.lastTime = Date.now();
        return logger.debug(this.lastTime + ": " + methName + " (" + (this.lastTime - this.startTime) + ")");
      },
